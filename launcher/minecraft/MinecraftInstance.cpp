...
void MinecraftInstance::loadSpecificSettings()
{
    ...
    if (auto global_settings = globalSettings()) {
        ...
        m_settings->registerOverride(global_settings->getSetting("GpuPreference"), performanceOverride);
...
QProcessEnvironment MinecraftInstance::createLaunchEnvironment()
{
    ...
    if (settings()->get("UseDiscreteGpu").toBool() || settings()->get("GpuPreference").toString() == "high_performance") {
